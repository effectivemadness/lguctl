...
const (
	...
	// NameDelimiter is a delimiter for name definition
	NameDelimiter = "//"
	...
	// DefaultAuthConnector means the default type of auth connector
	DefaultAuthConnector = "github"

	// DefaultSSHUser means the default user of ssh
