...
// FlagRegistry is a list of all lguctl CLI flags.
var FlagRegistry = []Flag{
	...
	},
	{
		...
		DefValue:      "default",
		FlagAddMethod: "StringVar",
		DefinedOn:     []string{"rds-token", "setup", "list", "renew-credential", "describe-web-acl", "has-ip", "start", "stop", "status", "exec", "ecr-login", "login", "ssh"},
	},
	{
		Name:          "raw-output",
	...
	{
		Name:          "apply-to-cli-profile",
		Shorthand:     "a",
		Usage:         "also apply to AWS CLI profile(~/.aws)",
		Value:         aws.Bool(false),
		DefValue:      false,
		FlagAddMethod: "BoolVar",
		DefinedOn:     []string{"setup"},
	},
	{
		Name:          "force",
		Shorthand:     "f",
		Usage:         "run operation forcefully ",
		Value:         aws.Bool(false),
		DefValue:      false,
		FlagAddMethod: "BoolVar",
		DefinedOn:     []string{"login"},
	},
}
